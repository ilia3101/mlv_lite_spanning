...
unsigned int raw_rec_update_preview(unsigned int ctx)
{
	...
	: (cam_eos_m || cam_100d || cam_650d || cam_700d || cam_6d || shamem_read(0xC0F06804) == 0xeee011b || shamem_read(0xC0F06804) == 0x93a011b || shamem_read(0xC0F06804) == 0x8d6011b) && RAW_IS_RECORDING ? RAW_PREVIEW_GRAY_ULTRA_FAST /* 1x3 binning mode test */
